...
class ThreadPool : public ThreadPoolInterface {
 public:
  ...
  size_t TaskQueueSize() { absl::MutexLock locker(&mutex_); return task_queue_.size(); }
  size_t TasksNotReadySize() { absl::MutexLock locker(&mutex_); return tasks_not_ready_.size(); }
